...
template <typename container_t, typename dependency_chain_t, lifetime_t min_lifetime>
class arg_t {
public:
    /*!
        value conversion
...
private:
    ...
    constexpr auto resolve() const -> deduced_t {
        ...
        return container_.template resolve<deduced_t, next_dependency_chain_t, min_lifetime>();
    }
};
...
public:
    /*!
        ...
        /sa arg_t<resolved_t, dependency_chain_t, lifetime>::operator deduced_t()
    */
